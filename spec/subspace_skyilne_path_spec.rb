...
MAX_IN_2_PATHS_MAXATTRS = {:p0_1_2_4_5=>[4.0], :p0_1_4_5=>[3.0], :p0_3_4_5=>[3.0], :p0_6_7_5=>[3.0]}
  ...
  describe '#query_subspace_skyline_path' do
    ...
    context 'when subspace is full space' do
      context 'and from 0 to 5' do
        ...
        describe '#set_max_attrs(2)' do
          it 'should get {:p0_1_4_5=>[40.0, 12.0, 1.0], :p0_6_7_5=>[36.0, 20.0, 1.0]}' do
            ssp.set_max_attrs(2)
            result = ssp.query_subspace_skyline_path(src_id: 0, dst_id: 5)
            expect(result).to eq({:p0_1_4_5=>[40.0, 12.0, 1.0], :p0_6_7_5=>[36.0, 20.0, 1.0]})
          end
        end
      end
    end
